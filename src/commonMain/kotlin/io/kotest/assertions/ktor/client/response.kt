...
private fun haveVersion(version: HttpProtocolVersion) = object : Matcher<HttpResponse> {
...
private fun haveContentType(contentType: ContentType) = object : Matcher<HttpResponse> {
   override fun test(value: HttpResponse): MatcherResult {
      return MatcherResult(
...
private fun haveHeader(headerName: String) = object : Matcher<HttpResponse> {
...
private fun haveHeader(headerName: String, headerValue: String) = object : Matcher<HttpResponse> {
   override fun test(value: HttpResponse): MatcherResult {
